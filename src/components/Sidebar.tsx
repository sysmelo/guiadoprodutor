...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const menuItems: { id: NavigationTab; label: string; icon: React.ElementType; badge?: string; shortcutKey?: string }[] = [
    ...
    { id: 'vocal_recording', label: 'Gravação & Tracking', icon: Radio, badge: 'FL Guide', shortcutKey: '^2' },
    { id: 'mix', label: 'Mix & Preparação', icon: Sliders, badge: 'Nível 1', shortcutKey: '^3' },
    { id: 'vocal_cleaning', label: 'Vocal Cleaning', icon: Mic, badge: 'Studio', shortcutKey: '^4' },
    { id: 'master', label: 'Master Suite', icon: Flame, badge: 'Nível 2', shortcutKey: '^5' },
    ...
    { id: 'export', label: 'Exportação & Guia', icon: Share2, badge: 'Nível 3', shortcutKey: '^0' },
